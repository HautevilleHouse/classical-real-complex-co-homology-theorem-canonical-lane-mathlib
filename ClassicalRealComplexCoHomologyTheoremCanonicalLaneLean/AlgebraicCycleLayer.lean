...
def NativeAlgebraicCycle.supportSubscheme {X : NativeScheme.{u}} (Z : NativeAlgebraicCycle X) : NativeScheme.{u} :=
  Z.supportIdeal.subscheme

def NativeAlgebraicCycle.hasSubschemeSupport {X : NativeScheme.{u}} (Z : NativeAlgebraicCycle X) : Prop :=
  Z.supportSubscheme = Z.supportIdeal.subscheme

theorem native_cycle_support_subscheme_checked {X : NativeScheme.{u}} (Z : NativeAlgebraicCycle X) :
